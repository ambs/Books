...
a C<super> method to call the previous defined block. 

=XXX Get example for :super
...
placed I<before> or I<after> the block.

=XXX Get example for before/after
...
Always remember that from your Perl code you must render the lowest
template in this hierarchy.

=head2 *Filters

=head2 *Virtual Methods

The documentation doesn't refer to the methods as virtual. The section
is named this way for homogeneity.

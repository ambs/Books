...
C<calculate_all_roles>, or to this class and all ancestors, with
C<calculate_all_roles_with_inheritance>. Check if a specific class
does a role with C<does_role>.

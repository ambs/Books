...
C<has_method> returns a boolean value given a method name. The value
...
C<add_method> lets you add method to the class. It receives the method
...
C<has_attribute> works just like C<has_method> but returns a true
